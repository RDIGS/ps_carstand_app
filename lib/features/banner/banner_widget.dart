...
/// Post 1:1 para redes sociais — layout replicado do protótipo HTML
/// fornecido pelo utilizador (fundo escuro, foto de fundo, faixa de dados
/// sobre gradiente, rodapé com contacto). Design fixo, propositadamente
/// independente da paleta da app (secção "cores do post" combinada com o
/// utilizador): só o ecrã à volta deste widget segue o tema da app.
///
        ...
        child: Stack(
          ...
          children: [
            if (content.foto != null)
              ...
              // Placeholder desenhado na app (sem depender de nenhuma foto
              // de stock) — só para pré-visualização, nunca é o que fica no
              // ficheiro final: "Gerar" continua bloqueado até haver foto real.
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            _EstatisticaItem(label: 'POTÊNCIA', valor: content.potencia),
                            _EstatisticaItem(label: 'ANO', valor: content.ano),
                            _EstatisticaItem(label: 'COMBUSTÍVEL', valor: content.combustivel),
                            Expanded(
                              child: Container(
    ...
    return ColoredBox(
      ...
      child: Center(
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(Icons.directions_car_outlined, size: 220, color: Colors.white.withValues(alpha: 0.25)),
...
class _EstatisticaItem extends StatelessWidget {
  const _EstatisticaItem({required this.label, required this.valor});
