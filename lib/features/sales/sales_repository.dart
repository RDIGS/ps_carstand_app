...
class SalesRepository {
  ...
  Future<SaleResult> create({
    ...
    String? transmitenteLocalidade,
    String? transmitenteEmail,
    ...
    return _api.request(
      ...
      data: {
        ...
        if (compradorLocalidade != null) 'compradorLocalidade': compradorLocalidade,
        if (compradorEmail != null) 'compradorEmail': compradorEmail,
